...
export function FacebookIcon({ size = 18, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
...
export function TiktokIcon({ size = 18, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
